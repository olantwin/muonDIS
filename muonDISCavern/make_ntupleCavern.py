...
hPInitialM = r.TH1F(
    "hPInitialM",
    "The momentum of the Initial  muons from the new Muon Background production 2018;P[GeV];Entries",
    400,
    0.0,
    400,
)
...
xyz = r.TH3D(
    "xyz",
    "XYZ position of muons with 3GeV momentum cut in the cavern",
    10,
    -15,
    15,
    10,
...
parser.add_argument("-f", "--inputFile", required=True, help="""Input file to use. """)

parser.add_argument("-g", "--geoFile", required=True, help="""GeoFile file to use. """)


pdg = r.TDatabasePDG.Instance()


parser.add_argument("-o", "--outputfile", default="muonsNewProduction.root")
